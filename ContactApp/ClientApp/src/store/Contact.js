...
export const actionCreators = {
    requestContacts: () => async (dispatch, getState) => {
        ...
        const url = "https://localhost:44337/api/ContactsAPI/Contacts";
    ...
    saveContact: contact => async (dispatch, getState) => {
        ...
        const url =   'https://localhost:44337/api/ContactsAPI/SaveContact';
    ...
    deleteContact: contactId => async (dispatch, getState) => {
        const url = 'https://localhost:44337/api/ContactsAPI/DeleteContact/' + contactId;
        const requestOptions = {
            method: 'DELETE',
        };
        const request = new Request(url, requestOptions);
